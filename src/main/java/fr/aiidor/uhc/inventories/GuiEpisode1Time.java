...
public class GuiEpisode1Time extends GuiConfigBuilder {

	@Override
	public String getTitle() {
		return Lang.INV_EP1_TIME_CONFIG.get();
	}
	...
	public Integer[] getBannersValues() {
		setCenter(new ItemBuilder(Material.WATCH, Lang.INV_EP1_TIME.get()).getItem());
	...
	public void addValue(Integer value) {
		if (UHC.getInstance().getGameManager().hasGame()) {
			...
			s.ep1_time = s.ep1_time + value;
			
			if (s.ep1_time <= 0) s.ep1_time = 0;
			if (s.ep1_time >= 120) s.ep1_time = 120;
		}
	}

	@Override
	public List<String> getLore() {
		return Arrays.asList(Lang.INV_EP1_TIME.get());
	}
}
